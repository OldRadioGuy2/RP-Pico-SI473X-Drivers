...
#define MAX_DELAY_AFTER_SET_FREQUENCY 10 // In ms - This value helps to improve the precision during of getting frequency value
#define MAX_DELAY_AFTER_POWERUP 50       // In ms - Max delay you have to setup after a power up command.
...
#ifdef RP_PICO
static void
interrupt_hundler(uint gpio, uint32_t event_mask)
{
...
protected:
    /*
     * A.F. Added the TwoWire Contstructor to provide an implementation
     * of the class.
     */
    TwoWire Wire;
